...
产物：`dist_electron/T8-PenguinCanvas-Setup-<version>.exe`（v1.6.1 = 合并上游 v1.5.8 主题图标按钮 / 跨平台默认路径 + v1.5.9 EVA 官方主题 + v1.6.0 EVA 浅色可读性 + fork 自有七牛 gpt-image-2 图生图 size 修复 / 1K/2K/4K 清晰度档 + grsai gpt-image-2-vip 比例 × 清晰度双控件，安装包约 110 MB）
