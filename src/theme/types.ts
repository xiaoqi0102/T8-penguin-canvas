...
export type ThemeVisualStyle = 'plain' | 'tech' | 'pixel' | 'op' | 'rh' | 'naruto' | 'eva' | 'yyh' | 'slamdunk';
...
export interface ThemeVisuals {
  ...
  iconPack?: 'default' | 'op' | 'naruto' | 'eva' | 'yyh' | 'slamdunk';
  canvasPattern?: 'none' | 'dots' | 'map' | 'circuit' | 'confetti' | 'hub' | 'chakra' | 'eva-grid' | 'spirit-map' | 'court';
  nodeFrame?: 'plain' | 'glass' | 'sticker' | 'wanted' | 'hub-card' | 'shinobi-scroll' | 'eva-panel' | 'spirit-case' | 'scoreboard-card';
  headerMark?: string;
}
